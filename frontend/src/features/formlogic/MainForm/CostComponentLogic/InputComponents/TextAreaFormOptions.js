...
const TextAreaFormOptions = ({options, tabId, costComponentTitle}) => {
    ...
    return (
        <div className={`text area option for Id: ?, Data Row Id: ${options}`}>
            {typeObj[options] === 'Multiline Text Field' &&
            <div>
                <textarea
...
export default TextAreaFormOptions;
